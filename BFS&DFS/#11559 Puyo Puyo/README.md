# <img width="20px"  src="https://d2gd6pc034wcta.cloudfront.net/tier/12.svg" class="solvedac-tier"> [Puyo Puyo](https://www.acmicpc.net/problem/11559) 

| 제출 번호 | 닉네임 | 채점 결과 | 메모리 | 시간 | 언어 | 코드 길이 |
|---|---|---|---|---|---|---|
|55100593| ryoo316|맞았습니다!! 맞았습니다!!|2024KB|0ms|C++17|3797B|
...
## 여담
<p>visited[s_x][s_y]를 visited[s_y][s_y]로 써서 내 3시간 날린 어이없는 문제!
